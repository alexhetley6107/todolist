...
const AddField = ({addToDo}) => {
  ...
  return (
    <div className="pb-7 mb-7 border-b-2 border-pink-500 ">

      <div className='bg-gray-700 p-3 w-full rounded-2xl flex justify-between'>

        <input className='bg-transparent border-none outline-none w-4/5'
          type='text' value={title} placeholder={'Add a task...'}
